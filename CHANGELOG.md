...
- Initial release of `HtmlRichTextFormField` and `HtmlRichTextController`.
- HTML codec backed by `package:html` with style ranges and list handling.
- Example Flutter app with all platforms enabled.
